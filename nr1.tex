...
\begin{tikzpicture}
	\begin{axis}[axis lines=middle,axis on top, grid=both,no markers,xlabel=$x$,ylabel=$y$,
		...
		\addplot+[thick, blue, solid, samples=10,name path=function1] {(x - 1) + x - (2*x + 1)};
		\addplot+[thick, blue, dashed, samples=10,name path=function2] {-(x - 1) + x - (2*x + 1)};
		\addplot+[thick, red, solid, samples=10,name path=function3] {(x - 1) + x - -(2*x + 1)};
		\addplot+[thick, red, dashed, samples=10,name path=function4] {-(x - 1) + x - -(2*x + 1)};
...
\begin{tikzpicture}
	\begin{axis}[axis lines=middle,axis on top, grid=both,no markers,xlabel=$x$,ylabel=$y$,
		...
		\addplot+[thick, blue,solid, samples=10,name path=function1] {(x) - (x + 2)};
		\addplot+[thick, blue, dashed, samples=10,name path=function2] {-(x) - (x + 2)};
		\addplot+[thick, red, solid, samples=10,name path=function3] {(x) - -(x + 2)};
		\addplot+[thick, red, dashed, samples=10,name path=function4] {-(x) - -(x + 2)};
		\addplot+[name path=axis] coordinates {(-10,0) (10,0)};
...
\begin{tikzpicture}
	\begin{axis}[axis lines=middle,axis on top, grid=both,no markers,xlabel=$x$,ylabel=$y$,
		...
		\addplot+[thick,blue,solid,samples=5,name path=function1] {(x+2) - (x-2) - x + 1};
		\addplot+[thick,blue,dashed,samples=5,name path=function2] {-(x+2) - (x-2) - x + 1};
		\addplot+[thick,red,solid,samples=5,name path=function3] {(x+2) - -(x-2) - x + 1};
		\addplot+[thick,red,dashed,samples=5,name path=function4] {-(x+2) - -(x-2) - x + 1};
		\addplot+[name path=axis] coordinates {(-10,0) (10,0)};
...
\begin{tikzpicture}
	\begin{axis}[axis lines=middle,axis on top, grid=both,no markers,xlabel=$x$,ylabel=$y$,
		...
		\addplot+[thick,blue,solid,samples=10,name path=function1]  {2*+(x+1) - 3*x + +(x+2)};
		\addplot+[thick,blue,dashed,samples=10,name path=function2] {2*-(x+1) - 3*x + +(x+2)};
		\addplot+[thick,red,solid,samples=10,name path=function3]   {2*+(x+1) - 3*x + -(x+2)};
		\addplot+[thick,red,dashed,samples=10,name path=function4]  {2*-(x+1) - 3*x + -(x+2)};
		\addplot+[name path=axis] coordinates {(-10,0) (10,0)};
		\addplot[green!20] fill between[ of=function1 and axis];
%		\addplot[green!20] fill between[ of=function3 and axis,split,
%		         every segment no 1/.style={opacity=1,white}];
...
\begin{tikzpicture}
	\begin{axis}[axis lines=middle,axis on top, grid=both,no markers,xlabel=$x$,ylabel=$y$,
		...
		\addplot+[thick,blue,solid,samples=10,name path=function1]  {+x - x};
		\addplot+[thick,blue,dashed,samples=10,name path=function2] {-x - x};
...
\begin{tikzpicture}
	\begin{axis}[axis lines=middle,axis on top, grid=both,no markers,xlabel=$x$,ylabel=$y$,
		...
		\addplot+[thick,blue,solid,samples=10,name path=function1] {+(2*x-1) - +(1-x)};
		\addplot+[thick,blue,dashed,samples=10,name path=function2] {-(2*x-1) - +(1-x)};
		\addplot+[thick,red,solid,samples=10,name path=function3] {+(2*x-1) - -(1-x)};
		\addplot+[thick,red,dashed,samples=10,name path=function4] {-(2*x-1) - -(1-x)};
...
\begin{tikzpicture}
	\begin{axis}[axis lines=middle,axis on top, grid=both,no markers,xlabel=$x$,ylabel=$y$,
		...
		\addplot+[thick,blue,solid,samples=10,name path=function1]  {+(x - 3) - +(2 - x) - +(x - 1)};
		\addplot+[thick,blue,dashed,samples=10,name path=function2] {-(x - 3) - +(2 - x) - +(x - 1)};
		\addplot+[thick,red,solid,samples=10,name path=function3]   {+(x - 3) - -(2 - x) - +(x - 1)};
		\addplot+[thick,red,dashed,samples=10,name path=function4]  {-(x - 3) - -(2 - x) - +(x - 1)};
		\addplot+[blue,solid,samples=10,name path=function5]        {+(x - 3) - +(2 - x) - -(x - 1)};
		\addplot+[blue,dashed,samples=10,name path=function6]       {-(x - 3) - +(2 - x) - -(x - 1)};
		\addplot+[red,solid,samples=10,name path=function7]         {+(x - 3) - -(2 - x) - -(x - 1)};
		\addplot+[red,dashed,samples=10,name path=function8]        {-(x - 3) - -(2 - x) - -(x - 1)};
		\addplot+[name path=axis] coordinates {(-5,0) (5,0)};
		\addplot[green!20] fill between[ of=function2 and axis,split,
		         every segment no 1/.style={opacity=1,white}];
...
\end{displaymath}
\begin{displaymath}
t = \pm \arcsin x \cdot n\pi; n \in Z
\end{displaymath}
\begin{displaymath}
y = \ln |\arcsin x \cdot n\pi| \pm 2\arcsin x + 2n\pi; n \in Z 
\end{displaymath}
\begin{tikzpicture}
	\begin{axis}[axis lines=middle,axis on top, grid=both,no markers,xlabel=$x$,ylabel=$y$,
		xmin=-7,xmax=7,
		...
		\addplot+[thick, domain=-8:8, samples=100,name path=function] {sin x};
		\addplot+[thick, domain=-8:8, samples=100,name path=function2] {ln x + 2 * x};
		\addplot+[thick, domain=-8:8, samples=100,name path=function2] {ln -x + 2 * x};
		\addplot+[name path=axis] coordinates {(-10,0) (10,0)};
		\addplot[white] fill between[ of=function and axis,split,
                every segment no 1/.style={green!20}];
